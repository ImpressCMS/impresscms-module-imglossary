...
echo '<div>';
echo '<div style="float: '._GLOBAL_LEFT.'; font-size: smaller;"><a href="' . ICMS_URL . '">' . _MD_IMGLOSSARY_HOME . '</a> >	<a href="' . ICMS_URL . '/modules/' . $xoopsModule -> dirname() . '/index.php">' . $xoopsModule -> name() . '</a> > ' . _MD_IMGLOSSARY_SUBMITART . '</div>';
