...
class imGlossaryModuleAbout {
	...
	function imGlossaryModuleAbout( $aboutTitle='About' ) {
		global $icmsConfig;
		...
		$this -> _lang_developer_contributor = _MODABOUT_IMGLOSSARY_DEVELOPER_CONTRIBUTOR;
		$this -> _lang_developer_website = _MODABOUT_IMGLOSSARY_DEVELOPER_WEBSITE;
		$this -> _lang_developer_email = _MODABOUT_IMGLOSSARY_DEVELOPER_EMAIL;
		$this -> _lang_developer_credits = _MODABOUT_IMGLOSSARY_DEVELOPER_CREDITS;
		$this -> _lang_module_info = _MODABOUT_IMGLOSSARY_MODULE_INFO;
		$this -> _lang_module_status = _MODABOUT_IMGLOSSARY_MODULE_STATUS;
		$this -> _lang_module_release_date =_MODABOUT_IMGLOSSARY_MODULE_RELEASE_DATE ;
		$this -> _lang_module_demo = _MODABOUT_IMGLOSSARY_MODULE_DEMO;
		$this -> _lang_module_support = _CO_ICMS_MODULE_SUPPORT;
		$this -> _lang_module_bug = _MODABOUT_IMGLOSSARY_MODULE_BUG;
		$this -> _lang_module_submit_bug = _MODABOUT_IMGLOSSARY_MODULE_SUBMIT_BUG;
		$this -> _lang_module_feature = _MODABOUT_IMGLOSSARY_MODULE_FEATURE;
		$this -> _lang_module_submit_feature = _CO_ICMS_MODULE_SUBMIT_FEATURE;
		$this -> _lang_module_disclaimer = _MODABOUT_IMGLOSSARY_MODULE_DISCLAIMER;
		$this -> _lang_author_word = _MODABOUT_IMGLOSSARY_AUTHOR_WORD;
		$this -> _lang_version_history = _MODABOUT_IMGLOSSARY_VERSION_HISTORY;
	}
	...
	function render() {
		...
		$this -> _tpl -> display( ICMS_ROOT_PATH . '/modules/' . icms::$module -> getVar( 'dirname' ) . '/templates/imglossary_moduleabout.html' );
