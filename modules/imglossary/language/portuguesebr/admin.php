...
define("_AM_IMGLOSSARY_ENTRYREFERENCE", "Referencia<span style='font-size: xx-small; font-weight: normal; display: block;'>(Escreva aqui a fonte da sua<br />definição, tais como um livro,<br />artigo, ou pessoa.)</span>");
...
define("_AM_IMGLOSSARY_SUBMITTER", "Apresentador");
