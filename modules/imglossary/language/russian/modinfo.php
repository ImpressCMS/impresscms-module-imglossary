...
define("_MI_IMGLOSSARY_SHOWCENTERDSC", "Выберите <em>Да</em> для отображения тройки центральных блоков: Новейшие, Популярные, Поиск на индексной странице.<br />Выберите <em>Нет</em> для замещения этих трех блоков блоком поиска.");
...
define( '_MI_IMGLOSSARY_FEEDSTOTAL', 'Количество терминов в RSS канале:' );
