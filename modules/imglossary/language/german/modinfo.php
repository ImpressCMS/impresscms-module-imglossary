...
define("_MI_IMGLOSSARY_SEARCHCOLORDSC", "Eintragen einer Farbe welche als Hintegrundfarbe für die Suchergebnisse genutzt werden soll. Standard ist: <span style='background-color: #FFFF00;'>&nbsp;#FFFF00&nbsp;</span>");
...
define("_MI_IMGLOSSARY_SHOWCENTER", "Zeige mittlere Blöcke?");
define("_MI_IMGLOSSARY_SHOWCENTERDSC", "Bei <em>Ja</em> werden 3 Blöcke angezeigt: neueste Einträge, populäre Einträge und eine Suche auf der Startseite des Modules.<br />Bei <em>Nein</em> werden die 3 Blöcke durch einen Suchblock ersetzt.");
define("_MI_IMGLOSSARY_SHOWRANDOM", "Zeige einen Begriff im Zufallsmodus?");
define("_MI_IMGLOSSARY_SHOWRANDOMDSC", "Bei <em>Ja</em> wird in einem Block ein Begriff per Zufall ausgewählt und in der Startseite des Modules dargestellt.");
define('_MI_IMGLOSSARY_EDITORADMIN', "Editor wählbar in der Administration:");
...
define('_MI_IMGLOSSARY_EDITORUSER', "Editor wählbar für die Benutzer:");
...
define("_MI_IMGLOSSARY_FORM_COMPACT", "Kompakt");
...
// version 1.01
define( '_MI_IMGLOSSARY_SELECTFEED', 'RSS-Feed benutzten?' );
define( '_MI_IMGLOSSARY_SELECTFEED_DSC', 'Voreinstellung: <em>Ja</em>'  );
define( '_MI_IMGLOSSARY_FEEDSTOTAL', 'Wieviele Begriffe sollen im RSS angezeigt werden?' );
define( '_MI_IMGLOSSARY_FEEDSTOTALDSC', 'Voreinstellung: <em>15</em>' );
?>