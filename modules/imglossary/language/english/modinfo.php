...
define("_MI_WB_ALLOWSUBMITDSC", "If set to <em>Yes</em>, users will have access to a submission form");

define("_MI_WB_ANONSUBMIT", "Can guests submit entries?");
define("_MI_WB_ANONSUBMITDSC", "If set to <em>Yes</em>, guests will have access to a submission form");

define("_MI_WB_DATEFORMAT", "In what format should the date appear?");
define("_MI_WB_DATEFORMATDSC", "Use the final part of language/english/global.php to select a display style.<br />See <a href='http://jp.php.net/manual/en/function.date.php' target='_blank'>PHP manual</a>");
...
define("_MI_WB_AUTOAPPROVEDSC", "If set to <em>Yes</em>, ImpressCMS will publish submitted entries without admin intervention.");

define("_MI_WB_MULTICATS", "Do you want to have glossary categories?");
define("_MI_WB_MULTICATSDSC", "If set to <em>Yes</em>, will allow you to have glossary categories. If set to no, will have a single automatic category.");

define("_MI_WB_CATSINMENU","Should the categories be shown in the menu?"); 
define("_MI_WB_CATSINMENUDSC","If set to <em>Yes</em> if you want links to categories in the main menu."); 
...
define("_MI_WB_ALLOWADMINHITSDSC", "If set to <em>Yes</em>, will increase counter for each entry on admin visits.");

define("_MI_WB_MAILTOADMIN", "Send mail to admin on each new submission?");  
define("_MI_WB_MAILTOADMINDSC", "If set to <em>Yes</em>, the manager will receive an e-mail for every submitted entry."); 
...
define("_MI_WB_LINKTERMSDSC", "If set to <em>Yes</em>, imGlossary will automatically link in your definitions those terms you already have in your glossaries.");

// Names of admin menu items
define("_MI_WB_ADMENU1", "Index");
define("_MI_WB_ADMENU2", "Add category");
define("_MI_WB_ADMENU3", "Add entry");
