...
*
* File: language/persian/modinfo.php
*
...
global $xoopsModule;
define("_MI_IMGLOSSARY_MD_NAME", "واژه نامه");
...
define("_MI_IMGLOSSARY_DATEFORMATDSC", "Use the part <em>TIME FORMAT SETTINGS</em> of language/persian/global.php to select a display style.<br />See <a href='http://jp.php.net/manual/en/function.date.php' target='_blank'>PHP manual</a>");
