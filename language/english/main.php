 ...
 * Licence: GNU
 */
define("_MD_WB_NOCOLEXISTS", "Sorry, there are no categories defined as of yet.<br />Please contact the site administrator and tell him about this.");
...
define("_MD_WB_RECEIVED", "The entry you sent has been received. We'll look at it as soon as possible.");
define("_MD_WB_RECEIVEDANDAPPROVED", "The entry you sent has been received. Since the auto-approve option is on, we'll publish it at once.");
...
define("_MD_WB_SECTIONNAME", "Glossary");
...
define("_MD_WB_SUB_SNEWNAMEDESC", "please fill the following form to submit your new entry to our site. As you're well aware, it'll have to be validated by an administrator before it gets published. However, if the administrator has activated the auto-approve setting, your entry will be published instantly.");
