...
define("_MI_IMGLOSSARY_ALLOWSUBMITDSC", "Se escolher <em>Sim</em>, os usuários terão acesso a um formulário para apresentar novos termos no glossário");

define("_MI_IMGLOSSARY_ANONSUBMIT", "Visitantes/Anônimos podem apresentar novos termos?");
define("_MI_IMGLOSSARY_ANONSUBMITDSC", "Se escolher <em>Sim</em>, visitantes/anônimos irão ter acesso a um formulário para o envio de novos termos no glossário");
...
define("_MI_IMGLOSSARY_PERPAGEDSC", "Número de entradas que será mostrado de uma vez na tabela que exibe as entradas ativas no lado do admin.");

define("_MI_IMGLOSSARY_PERPAGEINDEX", "Qual o Número de termos por página (No lado do Usuário)?");
...
define("_MI_IMGLOSSARY_AUTOAPPROVEDSC", "Se responder com <em>Sim</em>, Será atualizada e publicada a nova informação dentro do ImpressCMS sem a intervenção do admin deste módulo.");

define("_MI_IMGLOSSARY_MULTICATS", "Você quer ter categorias neste glossário?");
define("_MI_IMGLOSSARY_MULTICATSDSC", "Se escolheu a opção <em>Sim</em>, permitirá que seja montado categorias no seu glossário.  Se ficar definido como não, vai ter uma única categoria automáticamente para todos os seus termos.");

define("_MI_IMGLOSSARY_CATSINMENU","As categorias devem ser mostradas no menu?"); 
define("_MI_IMGLOSSARY_CATSINMENUDSC","Se informar <em>Sim</em> irá receber em seu menu principal todas as categorias que existirem dentro de seu módulo de glossário."); 
...
define("_MI_IMGLOSSARY_ALLOWADMINHITSDSC", "Se escolher esta opção com <em>Sim</em>, aumentará o contador para cada novo acesso do admin ao fazer visitas. Normalmente o Admin deve ser deixado como não.");

define("_MI_IMGLOSSARY_MAILTOADMIN", "Enviar e-mail para o admin a cada novo termo enviado?");  
define("_MI_IMGLOSSARY_MAILTOADMINDSC", "Se marcar esta opção com <em>Sim</em>, o gestor deste módulo irá receber um e-mail a cada novo termo que for apresentado."); 
...
define("_MI_IMGLOSSARY_LINKTERMSDSC", "Se responder <em>Sim</em>, imGlossary irá vincular automaticamente estas definições em seus termos caso estes já existam em seu glossário.");
...
define("_MI_IMGLOSSARY_SHOWSUBMITTERDSC", "Escolha <em>Sim</em> para mostrar quem foi o responsável por cada novo termo enviado.");
define("_MI_IMGLOSSARY_SHOWSBOOKMARKS","Mostrar um BookMark Social em cada termo?");
define("_MI_IMGLOSSARY_SHOWSBOOKMARKSDSC", "Escolha <em>Sim</em> para ter um ícone de BookMark Social visível em cada termo.");
